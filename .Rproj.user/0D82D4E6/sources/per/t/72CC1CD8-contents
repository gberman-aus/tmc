# This is the STM package manyTopics function. 
# I have made a slight edit to save the best performing model for each value of K.
...
#' }
#' @export
manyTopicsIterative <- function(documents, vocab, K, prevalence=NULL, content=NULL, 
  ...
  # My addition for making sure models are saved to the right directory
